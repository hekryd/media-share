export default {
    ...
    "account.shares.modal.delete.title": "Projekt löschen: {share}",
    ...
    "account.reverseShares.modal.max-size.label": "Maximale Projektgröße",
    "account.reverseShares.modal.send-email": "E-Mail Benachrichtigungen senden",
    "account.reverseShares.modal.send-email.description": "Sendet eine E-Mail Benachrichtigung, wenn eine Datei auf einem externen Projekt hochgeladen wurde.",
    "account.reverseShares.modal.simplified": "Einfacher Modus",
    "account.reverseShares.modal.simplified.description": "Mache es der Person, die die Datei hochlädt, einfach, sie mit dir zu teilen. Sie werden nur den Namen und die Beschreibung des Projektes ändern können.",
    ...
    "admin.shares.edit.delete.title": "Projekt löschen: {id}",
    ...
    "upload.dropzone.description": "Ziehe Dateien per Drag'n'Drop hierher, um dein Projekt zu starten. Wir akzeptieren nur Dateien mit einer Gesamtgröße von bis zu {maxSize}.",
    ...
    "share.modal.password.description": "Bitte geben Sie das Passwort ein, um auf dieses Projekt zuzugreifen.",
    ...
    "share.notify.download-all-preparing": "Das Projekt wird vorbereitet. Bitte versuchen Sie es in ein paar Minuten erneut.",
    ...
    "admin.config.email.enable-share-email-recipients": "Erlaube das Teilen des Projekts via E-Mail",
    ...
    "admin.config.email.reverse-share-subject.description": "Betreff der gesendeten E-Mail, wenn jemand ein Projekt mit Ihrem externen Projekt-Link erstellt.",
