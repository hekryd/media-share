export default {
  ...
  "account.reverseShares.modal.name.label": "Empfänger",
  "account.reverseShares.modal.name.placeholder": "Name des Empfänger",
  ...
  "account.reverseShares.table.name": "Empfänger",
  ...
  "account.reverseShares.table.max-size": "Maximale Uploadgröße",
