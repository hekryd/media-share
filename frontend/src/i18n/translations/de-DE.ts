export default {
  ...
  "navbar.links.shares": "Meine Projekte",
  "navbar.links.reverse": "Externe Projekte",
  ...
  "account.modal.delete.description": "Möchtest du wirklich dein Konto inklusive aller aktiven Projekte löschen?",
  // END /account
  // /account/shares
  "account.shares.title": "Meine Projekte",
  "account.shares.title.empty": "Es ist so leer hier 👀",
  "account.shares.description.empty": "Du hast keine Projekte erstellt.",
  "account.shares.button.create": "Erstelle eine",
  "account.shares.info.title": "Projekt Informationen",
  "account.shares.table.id": "ID",
  "account.shares.table.name": "Link",
  "account.shares.table.description": "Projekt",
  ...
  "account.reverseShares.description": "Ein externes Projekt erlaubt dir eine einzigartige URL zu erstellen, die externen Benutzern erlaubt, Dateien hochzuladen.",
  "account.reverseShares.title.empty": "Es ist leer hier 👀",
  "account.reverseShares.description.empty": "Du hast keine externen Projekte erstellt.",
  // showCreateReverseShareModal.tsx
  "account.reverseShares.modal.title": "Externes Projekt erstellen",
  ...
  "account.reverseShares.modal.max-size.label": "Max. Projektgröße",
  "account.reverseShares.modal.send-email": "Email Benachrichtigung senden",
  "account.reverseShares.modal.send-email.description": "Sendet eine Email Benachrichtigung, wenn eine Datei auf einem externen Projekt hochgeladen wurde.",
  "account.reverseShares.modal.simplified": "Einfacher Modus",
  "account.reverseShares.modal.simplified.description": "Mache es der Person einfach, die die Datei hochlädt, sie mit Dir zu teilen. Sie können nur den Namen und die Beschreibung des Projektes ändern.",
  "account.reverseShares.modal.public-access": "Öffentlicher Zugriff",
  "account.reverseShares.modal.public-access.description": "Mache die erstellten Projekte mit diesem externen Projekt öffentlich. Wenn deaktiviert, kannst nur du und der Ersteller des Projektes diese anzeigen.",
  ...
  "account.reverseShare.never-expires": "Dieses externe Projekt wird nicht ablaufen.",
  "account.reverseShare.expires-on": "Dieses externe Projekt wird am {expiration} ablaufen.",
  "account.reverseShares.table.no-shares": "Noch keine Projekte erstellt",
  "account.reverseShares.table.count.singular": "Projekt",
  "account.reverseShares.table.count.plural": "Projekte",
  "account.reverseShares.table.shares": "Projekte",
  "account.reverseShares.table.remaining": "Verbleibende Verwendungen",
  "account.reverseShares.table.max-size": "Maximale Projektgröße",
  "account.reverseShares.table.expires": "Läuft ab am",
  "account.reverseShares.modal.reverse-share-link": "Link zum externen Projekt",
  "account.reverseShares.modal.delete.title": "Lösche externes Projekt",
  "account.reverseShares.modal.delete.description": "Möchtest du wirklich dieses externe Projekt löschen? In diesem Falle werden auch hiermit verbundene Projekte gelöscht.",
  // END /account/reverseShares
  // /admin
  "admin.title": "Verwaltung",
  "admin.button.users": "Benutzerverwaltung",
  "admin.button.shares": "Projektverwaltung",
  ...
  "admin.users.edit.delete.description": "Möchtest du wirklich diesen Benutzer und all seine Projekte löschen?",
  ...
  // END /admin/users
  // /admin/shares
  "admin.shares.title": "Projektverwaltung",
  ...
  "admin.shares.edit.delete.title": "Lösche Projekt {id}",
  "admin.shares.edit.delete.description": "Möchtest du wirklich dieses Projekt löschen?",
  // END /admin/shares
  // /upload
  "upload.title": "Upload",
  ...
  "upload.modal.title": "Erstelle Projekt",
  ...
  "upload.modal.not-signed-in-description": "Du wirst dein Projekt nicht löschen können oder die Besucheranzahl sehen.",
  ...
  "upload.modal.accordion.name-and-description.description.placeholder": "Hinweis für die Empfänger dieses Projekts",
  ...
  "upload.modal.completed.never-expires": "Dieses Projekt läuft niemals ab.",
  "upload.modal.completed.expires-on": "Dieses Projekt wird am {expiration} ablaufen.",
  "upload.modal.completed.share-ready": "Projekt bereit",
  "upload.modal.completed.notified-reverse-share-creator": "Wir haben den Ersteller des externen Projekts benachrichtigt. Du kannst den Link auch auf andere Wege teilen.",
  // END /upload
  // /share/[id]
  "share.title": "Projekt {shareId}",
  "share.description": "Schau, was ich mit dir geteilt habe!",
  "share.error.visitor-limit-exceeded.title": "Besucher Limit erreicht",
  "share.error.visitor-limit-exceeded.description": "Die maximale Besucheranzahl für dieses Projekt ist überschritten.",
  "share.error.removed.title": "Projekt entfernt",
  "share.error.not-found.title": "Projekt nicht gefunden",
  "share.error.not-found.description": "Das gesuchte Projekt existiert nicht.",
  "share.error.visitor-limit-exceeded.description": "Die maximale Besucheranzahl für dieses Projekts ist überschritten.",
  "share.error.removed.title": "Projekt entfernt",
  "share.error.not-found.title": "Projekt nicht gefunden",
  "share.error.not-found.description": "Die gesuchte Projekte existiert nicht.",
  "share.error.access-denied.title": "Private Projekte",
  "share.error.access-denied.description": "Das aktuelle Konto hat keine Berechtigung, um auf dieses Projekt zuzugreifen",
  "share.modal.password.title": "Passwort erforderlich",
  "share.modal.password.description": "Um auf dieses Projekt zuzugreifen, gib bitte das Passwort für das Projekt ein.",
  ...
  "share.notify.download-all-preparing": "Das Projekt wird vorbereitet. Versuche es in ein paar Minuten erneut.",
  ...
  "share.edit.notify.generic-error": "Während der Erstellung des Projekts ist ein Fehler aufgetreten.",
  "share.edit.notify.save-success": "Projekt erfolgreich aktualisiert",
  // END /share/[id]/edit
  // /admin/config
  "admin.config.title": "Einstellungen",
  "admin.config.category.general": "Allgemein",
  "admin.config.category.share": "Projekt",
  ...
  "admin.config.email.enable-share-email-recipients": "Erlaube das Teilen des Projekts via Email",
  "admin.config.email.enable-share-email-recipients.description": "Gibt an, ob Emails an Projekt-Empfänger ermöglicht werden sollen. Aktiviere dies nur, wenn du SMTP aktivierst hast.",
  "admin.config.email.share-recipients-subject": "Betreff für Projekt-Empfänger",
  "admin.config.email.share-recipients-subject.description": "Betreff der E-Mail, die an die Projekt-Empfänger gesendet wird.",
  "admin.config.email.share-recipients-message": "Nachricht für Projekt-Empfänger",
  "admin.config.email.share-recipients-message.description": "Nachricht, die an die Projekt-Empfänger gesendet wird. Verfügbare Variablen:\n- {creator} - Der Benutzername des Erstellers des Projekts\n- {shareUrl} - Die URL des Projekts\n- {desc} - Die Beschreibung des Projekts\n- {expires} - Das Ablaufdatum des Projekts\nVariablen werden durch die tatsächlichen Werte ersetzt.",
  "admin.config.email.reverse-share-subject": "Name des externen Projekts",
  "admin.config.email.reverse-share-subject.description": "Betreff der Email, die gesendet wird, wenn jemand eine Datei mit deinem externen Projekt-Link hochlädt.",
  "admin.config.email.reverse-share-message": "Nachricht für externes Projekt",
  "admin.config.email.reverse-share-message.description": "Nachricht, die gesendet wird, wenn jemand ein Projekt mit deinem externen Projekt-Link erstellt. {shareUrl} wird durch den Namen des Erstellers und die Projekt-URL ersetzt.",
  ...
  "admin.config.share.allow-unauthenticated-shares": "Nicht authentifizierte Projekte erlauben",
  "admin.config.share.allow-unauthenticated-shares.description": "Gibt an, ob nicht authentifizierte Benutzer Projekte erstellen können",
  ...
  "admin.config.share.max-size.description": "Maximale Größe eines Projekts in Bytes",
  ...
  "admin.config.share.auto-open-share-modal": "Projekt-Fenster automatisch öffnen",
  "admin.config.share.auto-open-share-modal.description": "Das Projekt-Fenster erscheint automatisch, sobald ein Benutzer Dateien ausgewählt hat, ohne extra auf den Button klicken zu müssen.",
