export default {
  ...
  "navbar.links.shares": "Meine Uploads",
  "navbar.links.reverse": "Upload Anfrage",
  "navbar.avatar.account": "Mein Konto",
  "navbar.avatar.admin": "Verwaltung",
  "navbar.avatar.signout": "Abmelden",
  // END navbar
  // /
  "home.title": "Eine <h>selbst gehostete</h> Upload-Plattform.",
  ...
  "account.modal.delete.description": "Möchtest du wirklich dein Konto inklusive aller aktiven Uploads löschen?",
  // END /account
  // /account/shares
  "account.shares.title": "Meine Uploads",
  "account.shares.title.empty": "Es ist so leer hier 👀",
  "account.shares.description.empty": "Du hast keine Uploads erstellt.",
  "account.shares.button.create": "Erstelle eine",
  "account.shares.info.title": "Upload Informationen",
  "account.shares.table.id": "ID",
  "account.shares.table.name": "Titel",
  "account.shares.table.description": "Hinweis für H+R",
  "account.shares.table.description.short": "Hinweis",
  "account.shares.table.visitors": "Views",
  "account.shares.table.expiresAt": "Läuft ab am",
  "account.shares.table.expiresAt.short": "Ablauf",
  "account.shares.table.createdAt": "Erstellt am",
  "account.shares.table.createdAt.short": "Erstellt",
  ...
  "account.shares.modal.share-link": "Upload teilen",
  "account.shares.modal.delete.title": "Upload löschen: {share}",
  "account.shares.modal.delete.description": "Möchtest du diesen Upload wirklich löschen?",
  // END /account/shares
  // /account/reverseShares
  "account.reverseShares.title": "Upload Anfragen",
  "account.reverseShares.description": "Eine Upload Anfrage erlaubt dir eine einzigartige URL zu erstellen, die externen Benutzern erlaubt, Dateien hochzuladen.",
  "account.reverseShares.title.empty": "Es ist leer hier 👀",
  "account.reverseShares.description.empty": "Du hast keine Upload Anfragen erstellt.",
  // showCreateReverseShareModal.tsx
  "account.reverseShares.modal.title": "Externen Upload erstellen",
  "account.reverseShares.modal.name.label": "Anfrage Empfänger",
  "account.reverseShares.modal.name.placeholder": "Kunde, Mitarbeiter",
  ...
  "account.reverseShares.modal.max-size.label": "Maximale Uploadgröße",
  "account.reverseShares.modal.send-email": "E-Mail Benachrichtigungen senden",
  "account.reverseShares.modal.send-email.description": "Sendet eine E-Mail Benachrichtigung, wenn eine Datei auf Ihrer externen Upload hochgeladen wurde.",
  "account.reverseShares.modal.simplified": "Einfacher Modus",
  "account.reverseShares.modal.simplified.description": "Mache es der Person, die die Datei hochlädt, einfach, sie mit dir zu teilen. Sie werden nur den Namen und die Beschreibung des Upload ändern können.",
  "account.reverseShares.modal.public-access": "Öffentlicher Zugriff",
  "account.reverseShares.modal.public-access.description": "Mache die Uploads die mit diesem externen Upload erstellt werden öffentlich. Wenn dies deaktiviert ist, haben nur du und der Ersteller des Uploads Zugriff darauf.",
  ...
  "account.reverseShare.never-expires": "Dieser externe Upload wird nicht ablaufen.",
  ...
  "account.reverseShares.table.remaining": "VV",
  "account.reverseShares.table.remaining.tooltip": "Verbleibende Verwendungen",
  "account.reverseShares.table.max-size": "Max",
  "account.reverseShares.table.max-size.tooltip": "Maximale Uploadgröße",
  "account.reverseShares.table.expires": "Läuft ab am",
  "account.reverseShares.modal.reverse-share-link": "Link zum externen Upload",
  "account.reverseShares.modal.delete.title": "Externen Upload löschen",
  "account.reverseShares.modal.delete.description": "Möchtest du diesen externen Upload wirklich löschen? In diesem Fall werden auch hiermit verbundene Uploads gelöscht.",
  // END /account/reverseShares
  // /admin
  "admin.title": "Verwaltung",
  "admin.button.users": "Benutzerverwaltung",
  "admin.button.shares": "Upload Verwaltung",
  ...
  "admin.users.edit.delete.description": "Möchtest du wirklich diesen Benutzer und all seine Uploads löschen?",
  ...
  // END /admin/users
  // /admin/shares
  "admin.shares.title": "Upload Verwaltung",
  "admin.shares.table.id": "Upload ID",
  "admin.shares.table.username": "Upload Ersteller",
  "admin.shares.table.username.short": "Ersteller",
  "admin.shares.table.visitors": "Besucher",
  "admin.shares.table.expires": "Läuft ab am",
  "admin.shares.edit.delete.title": "Upload löschen: {id}",
  "admin.shares.edit.delete.description": "Möchtest du diesen Upload wirklich löschen?",
  // END /admin/shares
  // /upload
  "upload.title": "Upload",
  "upload.notify.confirm-leave": "Bist du sicher, dass du diese Seite verlassen willst? Dein Upload wird abgebrochen.",
  "upload.notify.generic-error": "Während der Erstellung des Uploads ist ein Fehler aufgetreten.",
  ...
  "upload.modal.title": "",//Erstelle Upload
  ...
  "upload.modal.not-signed-in-description": "Du wirst deinen Upload nicht löschen können oder die Besucheranzahl sehen.",
  "upload.modal.expires.never": "nie",
  "upload.modal.expires.never-long": "Permanenter Upload",
  ...
  "upload.modal.completed.never-expires": "Dieser Upload läuft niemals ab.",
  "upload.modal.completed.expires-on": "Dieser Upload wird am {expiration} ablaufen.",
  ...
  "share.error.visitor-limit-exceeded.description": "Die maximale Besucheranzahl für diesen Upload ist überschritten.",
  "share.error.removed.title": "Upload entfernt",
  "share.error.not-found.title": "Upload nicht gefunden",
  "share.error.not-found.description": "Der gesuchte Upload existiert nicht.",
  "share.error.access-denied.title": "Privater Upload",
  "share.error.access-denied.description": "Das aktuelle Konto hat keine Berechtigung, um auf diesen Upload zuzugreifen",
  "share.modal.password.title": "Passwort erforderlich",
  "share.modal.password.description": "Bitte gib das Passwort ein, um auf diesen Upload zuzugreifen.",
  ...
  "share.notify.download-all-preparing": "Der Upload wird vorbereitet. Bitte versuche es in ein paar Minuten erneut.",
  ...
  "share.edit.notify.generic-error": "Während der Erstellung des Upload ist ein Fehler aufgetreten.",
  "share.edit.notify.save-success": "Upload erfolgreich aktualisiert",
  // END /share/[id]/edit
  // /imprint
  ...
  "admin.config.category.share": "Upload",
  ...
  "admin.config.email.enable-share-email-recipients": "Erlaube das Teilen von Uploads via E-Mail",
  ...
  "admin.config.email.share-recipients-subject": "Betreff für Upload-Empfänger",
  "admin.config.email.share-recipients-subject.description": "Betreff der E-Mail, die an die Upload-Empfänger gesendet wird.",
  "admin.config.email.share-recipients-message": "Nachricht für Upload-Empfänger",
  "admin.config.email.share-recipients-message.description": "Nachricht, die an die Upload-Empfänger gesendet wird. Verfügbare Variablen:\n- {creator} - Der Benutzername des Erstellers des Upload\n- {creatorEmail} - E-Mail-Adresse des Erstellers des Upload\n- {shareUrl} - Die URL des Upload\n- {desc} - Die Beschreibung des Upload\n- {expires} - Das Ablaufdatum des Upload\nVariablen werden durch die tatsächlichen Werte ersetzt.",
  ...
  "admin.config.share.allow-unauthenticated-shares": "Nicht authentifizierte Uploads erlauben",
  "admin.config.share.allow-unauthenticated-shares.description": "Gibt an, ob nicht authentifizierte Benutzer Uploads erstellen können",
  ...
  "admin.config.share.share-id-length": "Standardlänge der Upload-ID",
  "admin.config.share.share-id-length.description": "Standardlänge für die generierte ID eines Upload. Dieser Wert wird auch verwendet, um Links für umgekehrte Uploads zu generieren. Ein Wert unter 8 wird als nicht sicher betrachtet.",
  "admin.config.share.max-size": "Maximale Größe",
  "admin.config.share.max-size.description": "Maximale Größe eines Upload",
  ...
  "admin.config.share.auto-open-share-modal": "Upload-Fenster automatisch öffnen",
  "admin.config.share.auto-open-share-modal.description": "Das Upload-Fenster erscheint automatisch, sobald ein Benutzer Dateien ausgewählt hat, ohne extra auf den Button klicken zu müssen.",
  ...
  "common.notify.copied-id": "Die ID wurde in die Zwischenablage kopiert",
...
//H+R stuff
  ...
  "index.uploadTitle": "Ihr Datei-Upload an die Hektor + Rydzewski GmbH",
  "index.uploadTitleTooltip": 
      ...
      "Mail: post@hektor-rydzewski.de\n",
  "index.click": "Bitte klicken Sie hier",
};